...
import { checkLogin } from "../apiProject/loginService";
				...
				<div className="row justify-content-center">
					...
					<div className="col-md-6 d-flex align-items-center">
						<div>
							...
							<p className="lead">Đăng nhập để trải nghiệm các dịch vụ và tiện ích hàng đầu của chúng tôi.</p>
						</div>
					</div>
					...
					<div className="col-md-6">
						<div className="card shadow">
							<div className="card-body">
								...
								<Formik initialValues={user} onSubmit={handleSubmit} validationSchema={handleValidate}>
									<Form>
										<div className="mb-3">
